 ...
 */
final class Version20230329211246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs DROP FOREIGN KEY FK_497B315E4C86C134');
        $this->addSql('DROP INDEX IDX_497B315E4C86C134 ON utilisateurs');
        $this->addSql('ALTER TABLE utilisateurs DROP groupes_users_id, CHANGE roles roles JSON NOT NULL, CHANGE nom nom VARCHAR(50) DEFAULT \'inconnu\', CHANGE prenom prenom VARCHAR(255) DEFAULT \'inconnu\', CHANGE num_tel num_tel VARCHAR(20) DEFAULT \'Unknown\', CHANGE genre genre VARCHAR(10) DEFAULT NULL, CHANGE fichier_photo fichier_photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajets CHANGE t_arrivee t_arrivee DATETIME DEFAULT \'NULL\', CHANGE prix prix DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE utilisateurs ADD groupes_users_id INT DEFAULT NULL, CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`, CHANGE nom nom VARCHAR(50) DEFAULT \'\'\'inconnu\'\'\', CHANGE prenom prenom VARCHAR(255) DEFAULT \'\'\'inconnu\'\'\', CHANGE num_tel num_tel VARCHAR(20) DEFAULT \'\'\'Unknown\'\'\', CHANGE genre genre VARCHAR(10) DEFAULT \'NULL\', CHANGE fichier_photo fichier_photo VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE utilisateurs ADD CONSTRAINT FK_497B315E4C86C134 FOREIGN KEY (groupes_users_id) REFERENCES groupes (id)');
        $this->addSql('CREATE INDEX IDX_497B315E4C86C134 ON utilisateurs (groupes_users_id)');
    }
}
